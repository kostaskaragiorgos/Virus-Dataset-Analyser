...
class Virus_Dataset_Analyser():
    ...
    def __init__(self, master):
        ...
        self.show_menu.add_command(label="Show infected countries", accelerator='Control+S', command=self.infcountries)
        self.menu.add_cascade(label="Show", menu=self.show_menu)
        self.cases_graph_menu = Menu(self.menu, tearoff=0)
        self.cases_graph_menu.add_command(label="Show cases by country", accelerator='Control+T', command=self.casesbycountry)
